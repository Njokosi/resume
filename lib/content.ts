...
export const work: ResumeItem[] = [
  ...
  },
  {
    ...
    description: [
      ...
      'Optimized backend queries, reducing dashboard load time from 14s to 500ms.',
    ],
    technologies: [
      'Celery',
      'RabbitMQ',
  ...
  },
  {
    ...
    description: [
      'Led development of “WebGuard,” a security monitoring and response tool that proactively identified and mitigated vulnerabilities across multiple government platforms.',
      'Led two 4-member teams in developing internal tools to oversee operations, streamlining workflows and supporting the rollout of three national-scale web applications.',
      'Engineered a secure online meeting system (mikutano.gov.go.tz) supporting 100+ concurrent government sessions with encryption and access control.',
      'Developed a digital board meeting platform (eboard.gov.go.tz) using Spring Boot, enabling document sharing, e-voting, and real-time collaboration.',
      'Built cross-platform desktop tools with Electron to streamline internal workflows and integrate with backend systems.',
      'Developed the national citizen feedback platform (emrejesho.gov.go.tz), enabling secure submission, tracking, and resolution of complaints, suggestions, inquiries, and commendations, with high availability and adherence to government security standards.',
    ],
    technologies: [
      'JavaScript',
      'Spring Boot',
  ...
  {
    title:
      'Computer Engineer · Agricom & Bravo Logistics',
    href: 'https://bravo.co.tz',
  ...
  {
    title:
      'Computer Engineer Intern· Judiciary of Tanzania',
    href: 'https://portal.judiciary.go.tz',
...
export const education: EducationItem[] = [
  ...
  {
    title:
      'Certificate in French Studies (Level 1) · Université Badji Mokhtar Annaba',
    date: '2015 · 2016',
